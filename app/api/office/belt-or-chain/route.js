...
const ENGINES = [
  ...
  {
    name: "Ford 1.0 EcoBoost (wet belt, earlier)",
    makeContains: ["FORD"],
    fuel: ["PETROL"],
    ccMin: 995,
    ccMax: 1000,
  ...
  {
    name: "Ford 1.0 EcoBoost (timing chain, later)",
    makeContains: ["FORD"],
    fuel: ["PETROL"],
    ccMin: 995,
    ccMax: 1000,
    ...
    type: "chain",
    partNumber: "",
    notes: "Later Ford dropped the wet belt for a conventional timing chain on this generation. Fitted to later Fiesta, Focus & Puma. Confirm by registration/VIN — shares model names with the earlier wet-belt version.",
  },
  {
    name: "Ford EcoBlue 1.5 (wet belt)",
    makeContains: ["FORD"],
    fuel: ["DIESEL"],
    ccMin: 1495,
    ccMax: 1505,
    ...
    type: "belt",
    partNumber: "",
    notes: "Wet-belt design. Fitted to Focus, Kuga, Puma & EcoSport.",
  },
  {
    name: "Ford EcoBlue 2.0 (wet belt, Ranger/Transit)",
    makeContains: ["FORD"],
    fuel: ["DIESEL"],
    ccMin: 1990,
    ccMax: 2000,
    ...
    type: "belt",
    partNumber: "",
    notes: "Wet-belt design. Fitted to Ranger, Transit & Transit Custom.",
  },
  {
    name: "VAG 2.0 TSI/TFSI (timing chain)",
    makeContains: ["VOLKSWAGEN", "AUDI", "SEAT", "SKODA", "ŠKODA"],
    fuel: ["PETROL"],
    ccMin: 1975,
    ccMax: 1995,
    yearMin: 2008,
    ...
    type: "chain",
    partNumber: "",
    notes: "EA888-family petrol. Fitted to Golf, A3, Leon, Octavia & more. Known for chain-stretch/tensioner wear, especially earlier Gen1/Gen2 units.",
  },
  {
    name: "VAG 2.0 TDI (timing belt)",
    makeContains: ["VOLKSWAGEN", "AUDI", "SEAT", "SKODA", "ŠKODA"],
    fuel: ["DIESEL"],
    ccMin: 1960,
    ccMax: 1970,
    ...
    type: "belt",
    partNumber: "",
    notes: "Fitted to Golf, Passat, A4, Octavia & more. Belt-driven — always fit a new water pump at the same time.",
  },
  {
    name: "Renault 1.2 TCe (timing chain)",
    makeContains: ["RENAULT"],
    fuel: ["PETROL"],
    ccMin: 1195,
    ccMax: 1200,
    yearMin: 2012,
    ...
    type: "chain",
    partNumber: "",
    notes: "H5F engine. Fitted to Clio, Captur, Mégane, Scénic & Kadjar.",
  },
  {
    name: "Renault/Vauxhall/Nissan 2.3 dCi (timing chain)",
    makeContains: ["RENAULT", "VAUXHALL", "NISSAN", "FIAT"],
    fuel: ["DIESEL"],
    ccMin: 2295,
    ccMax: 2305,
    yearMin: 2010,
    ...
    type: "chain",
    partNumber: "",
    notes: "M9T commercial engine, shared across Renault Master III, Trafic III, Vauxhall Movano, Nissan NV400 & Fiat/Vauxhall Talento. Secondary/balancer chain & guides can also need replacing.",
  },
  {
    name: "Vauxhall 1.4 Ecotec (timing chain)",
    makeContains: ["VAUXHALL"],
    fuel: ["PETROL"],
    ccMin: 1395,
    ccMax: 1400,
    yearMin: 2010,
    ...
    type: "chain",
    partNumber: "",
    notes: "Fitted to Corsa, Astra, Meriva, Mokka & Adam.",
  },
  {
    name: "PSA/Stellantis 1.2 PureTech (wet belt)",
    makeContains: ["PEUGEOT", "CITROEN", "CITROËN", "VAUXHALL", "DS"],
    fuel: ["PETROL"],
    ccMin: 1195,
    ccMax: 1200,
    yearMin: 2012,
    ...
    type: "belt",
    partNumber: "",
    notes: "Wet-belt design, one of the most common causes of engine damage on this platform. Shared across Peugeot, Citroën, Vauxhall & DS once Vauxhall joined the PSA/Stellantis group.",
  },
  {
    name: "Peugeot/Citroën 1.6 HDi (timing belt)",
    makeContains: ["PEUGEOT", "CITROEN", "CITROËN"],
    fuel: ["DIESEL"],
    ccMin: 1550,
    ccMax: 1620,
    yearMin: 2004,
    ...
    type: "belt",
    partNumber: "",
    notes: "DV6 diesel. Fitted to 207/307/308, 407/508/3008, Partner, C3/C4/C4 Picasso, C5 & Berlingo. Not fitted to Vauxhall or DS — Vauxhall joined the PSA group after this engine's production ended. Always fit a new water pump plus oil & filter at the same time.",
  },
];
