...
// 20% standard-rate VAT, applied to each Quotes line item so a posted Zoho
// Estimate shows VAT the same way a Bill does in accounts-hub (same Zoho
// Books account, same tax rate). Only Warrington 4x4 has a tax rate
// configured in Zoho — see accounts-hub's lib/constants.js for the same
// caveat on the purchasing side.
export const ZOHO_VAT_TAX_IDS = {
  "Warrington 4x4": "982743000000169034", // Standard Rate, 20%
};
