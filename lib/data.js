...
export async function fetchAll() {
  const [parts, jobTypes, bookings, jobCards, jobApprovals, settings, priceHistory, stockBatches, brands, holidays, bonusRates, staffWages, fixedCosts, auditLog] = await Promise.all([
    fetchParts(), fetchJobTypes(), fetchBookings(), fetchJobCards(), fetchJobApprovals(), fetchSettings(), fetchPriceHistory(), fetchStockBatches(), fetchBrands(), fetchHolidays(), fetchBonusRates(), fetchStaffWages(), fetchFixedCosts(), fetchAuditLog(),
  ]);
  return { parts, jobTypes, bookings, jobCards, jobApprovals, settings, priceHistory, stockBatches, brands, holidays, bonusRates, staffWages, fixedCosts, auditLog };
}
