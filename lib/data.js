...
export async function fetchAll() {
  const [parts, jobTypes, bookings, jobCards, jobApprovals, settings, priceHistory, stockBatches, brands] = await Promise.all([
    fetchParts(), fetchJobTypes(), fetchBookings(), fetchJobCards(), fetchJobApprovals(), fetchSettings(), fetchPriceHistory(), fetchStockBatches(), fetchBrands(),
  ]);
  return { parts, jobTypes, bookings, jobCards, jobApprovals, settings, priceHistory, stockBatches, brands };
}
