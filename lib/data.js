...
export async function fetchAll() {
  const [parts, jobTypes, bookings, jobCards, jobApprovals, settings, priceHistory, stockBatches] = await Promise.all([
    fetchParts(), fetchJobTypes(), fetchBookings(), fetchJobCards(), fetchJobApprovals(), fetchSettings(), fetchPriceHistory(), fetchStockBatches(),
  ]);
  return { parts, jobTypes, bookings, jobCards, jobApprovals, settings, priceHistory, stockBatches };
}
