...
export async function fetchBookings() {
  const [{ data, error }, { data: extras, error: e2 }, { data: extraParts, error: e3 }, { data: jobTypePrices, error: e4 }, { data: bomQtyOverrides, error: e5 }, extraCostsResult] = await Promise.all([
    ...
    // Not `must()`-ed like the others — this table's much newer, so a
    // missing-migration gap (or any other hiccup fetching it) shouldn't be
