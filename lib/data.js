...
const supplierInvoiceFromRow = (r) => ({
  ...
  zohoBillId: r.zoho_bill_id || null, zohoBillNumber: r.zoho_bill_number || null, zohoBillUrl: r.zoho_bill_url || null,
...
export async function updateSupplierInvoice(id, patch) {
  ...
  if (patch.zohoBillId !== undefined) row.zoho_bill_id = patch.zohoBillId;
  if (patch.zohoBillNumber !== undefined) row.zoho_bill_number = patch.zohoBillNumber;
  if (patch.zohoBillUrl !== undefined) row.zoho_bill_url = patch.zohoBillUrl;
...
export async function updateBookingRow(id, patch) {
  ...
  const map = {
    ...
    arrived: "arrived", arrivedAt: "arrived_at", transportConfirmed: "transport_confirmed",
