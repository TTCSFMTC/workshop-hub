...
export default function WorkshopHub() {
  ...
  const addBooking = (booking) => withSaveState(async () => {
    ...
    try {
      ...
      // Includes the actual error text (not just "something went wrong") —
      // this is what caught a missing-migration bug within minutes instead
      // of it looking like a mystery connection issue.
